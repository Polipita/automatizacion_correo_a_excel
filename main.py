...
def procesar_correo():
    ...
    mail.select("inbox")
    #por ahora solo es de hoy para evitar vovler cargar facturas anteriores
    ...
    for num in ids_correos:
        ...
        if es_remitente_valido:
            ...
            for parte in mensaje.walk():
                ...
                if parte.get_content_type() == "application/pdf" and "attachment" in content_disposition:
                    ...
                    if nombre_archivo:
                        ...
                        print(f"se guarda el pdf : {nombre_archivo}")
            ...
            print("no es correo de confianza")
